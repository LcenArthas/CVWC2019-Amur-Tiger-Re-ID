...
# Name of body
_C.MODEL.BODYNAME = 'resnet18'
# Last stride of backbone
_C.MODEL.LAST_STRIDE = 1
# Path to pretrained model of backbone
_C.MODEL.PRETRAIN_PATH = ''
# Path to pretrained model of body_stream
_C.MODEL.PRETRAIN_BODYPATH = ''
...
#-------------------------------------------------------------------------------
_C.PART = CN()
# Size of the put part body
_C.PART.SIZE_BODY = [64, 128]
# Size of the put part paw
_C.PART.SIZE_PAW = [64, 64]
...
# Random probability for image rotation
_C.INPUT.RO_DEGREE = 10
# Random probabilty for image brightness
_C.INPUT.BRIGHT_PROB = 0.2
# Random probabilty for image saturation
_C.INPUT.SATURA_PROB = 0.2
# Random probabilty for image contrast
_C.INPUT.CONTRAST_PROB = 0.2
# Random probabilty for image hue
